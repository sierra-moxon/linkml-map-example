# Contributing to linkml-map-example

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
linkml-map-example. These guidelines are not strict rules.
...
The linkml-map-example team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the linkml-map-example technical leads
...
[issues]: https://github.com/sierra-moxon/linkml-map-example/issues/
[pulls]: https://github.com/sierra-moxon/linkml-map-example/pulls/
